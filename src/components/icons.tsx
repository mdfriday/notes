...
export const Logo: React.FC<IconSvgProps> = ({
    ...
    <svg
        ...
        viewBox="203.83 275.21 201.06 201.06"  // 修改 viewBox
        width={size}
        height={height ?? size}
        {...props}
    >
      <path
          fill="#004ea2"  // 确保颜色可见
          d="M259.32,275.21c-37.47,0-49.64,20.5-53.59,50.89h13l35.62,54.28
      l35.38-54.28h43.42V426.75h17l-40.36,38.19l-42.15-38.19H289V360.58l-42.72,66.17H242L203.83,369v6.78
      c0,55.52,0,100.53,55.49,100.53s145.57-45,145.57-100.53S314.84,275.21,259.32,275.21Z"
      />
    </svg>
);
